...
class EventDetail extends Component {
	render() {
		let winner;
		if (this.props.event.winner) {
			if (this.props.event.winner === 1) {
		...
		if (this.props.event.guestlists.length === 0) {
			...
			guestlist = this.props.event.guestlists.map(function(guestList, i) {
				return (
		...
		return (
			<div className="events-page">
				...
				{(!this.props.event.vote_status || this.props.user.voted) &&
					<div className="event-details">
						...
						<div className="flex-item-header">
							...
							<div className="flex-item">
								{this.props.event.speaker || `Nobody lined up yet...`}
							</div>
						</div>
						<div className="flex-item-header">
